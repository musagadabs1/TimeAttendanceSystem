...
namespace TimeAttendanceSystem.Reports {
    ...
    public class DailyErrorReport : ReportClass {
        
        public DailyErrorReport() {
        }
        
        public override string ResourceName {
            get {
                return "DailyErrorReport.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TimeAttendanceSystem.Reports.DailyErrorReport.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedDailyErrorReport : Component, ICachedReport {
        
        public CachedDailyErrorReport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            DailyErrorReport rpt = new DailyErrorReport();
            rpt.Site = this.Site;
            return rpt;
        }
